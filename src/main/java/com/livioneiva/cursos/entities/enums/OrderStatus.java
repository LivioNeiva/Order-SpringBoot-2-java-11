...
public enum OrderStatus {
	...
	/*
	aparti do momento q vamos colocando os enums, uma ordem vai se criando para cada enum
	...
	//reorna os codigos dos enum valido, chega se code é valido
	public static OrderStatus valueOf(int code) {
		//value() -> é um arrys q retorna todos os enums da classe
